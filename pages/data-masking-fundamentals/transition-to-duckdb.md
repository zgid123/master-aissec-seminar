...
<div v-click="4" class="mt-5 text-center handoff-box">
Câu trả lời ở <b class="text-[#2efab0]">Section 3 — Dynamic Data Masking trong DuckDB</b>
</div>
...
[CLICK 1] "Trong một DBMS truyền thống, việc che dữ liệu dựa trên user, role và GRANT — và chính database server là nơi thực thi policy đó. Người dùng thông thường không dễ đi vòng qua được."
(NÓI "KHÔNG DỄ", ĐỪNG NÓI "KHÔNG THỂ" — vì DBA / superuser thì vẫn có đường khác, và Section 4 sẽ phân tích đúng chỗ đó. Nói tuyệt đối là dễ bị phản biện.)
...
[CLICK 4 — hiện dòng bàn giao. Ngừng 1 giây, quay người và hướng ánh mắt sang Trần Huy Vũ]
